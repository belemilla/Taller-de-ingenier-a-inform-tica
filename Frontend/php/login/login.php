...
if (!empty($_POST["btningresar"])) {                  //cuando se preciona el boton
    $nombre = trim($_POST["user"] ?? '');    // validacion de campo
    $pass = $_POST["pass"] ?? '';                   // validacion de campo
    ...
    if (empty($nombre) || empty($pass)) {
        ...
        //si se encuantra un admistrador se toma su "$id_usuario"
        ...
        // si no, se busca en la tabla huesped
            ...
            //si se encuantra un huesped se toma su "$id_usuario"
